...
<div class="row">
    ...
    {{-- Se muestran los errores al crear registros --}}
    @if ($errors->any())
    ...
    <form action="{{route('tasks.update', $task)}}" method="POST"> {{-- Se pasa a donde se env+ia y la tarea --}}
        @csrf {{-- Se utiliza para evitar ataques cross-site request forgery --}}
        @method('PUT') {{-- Es para poder enviar el formulario, porque espera el método PUT o PATCH usados en APIs --}}
        <div class="row">
